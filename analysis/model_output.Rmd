...
item_model <-  bind_rows(
  fread("../model/output/spin-within_model_item_slope-10_burn0_lag0_chain1.csv")%>%mutate(chain = "1"),
  fread("../model/output/spin-within_model_item_slope-10_burn0_lag0_chain2.csv")%>%mutate(chain = "2")
)
