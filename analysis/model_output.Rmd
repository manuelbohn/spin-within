...
```{r}
model <-  bind_rows(
  fread("../model/output/spin-within_model-20000_burn50000_lag4_chain1.csv")%>%mutate(chain = "1"),
  fread("../model/output/spin-within_model-20000_burn50000_lag4_chain2.csv")%>%mutate(chain = "2"),
  fread("../model/output/spin-within_model-20000_burn50000_lag4_chain3.csv")%>%mutate(chain = "3")
...
model%>%
  ...
  ggplot(., aes(x = value, fill = chain))+
  geom_density(alpha = .5)+
  ggtitle("Seamntick knowledge for 'lock'")+
  facet_wrap(subject~., scales = "free_y")+
  scale_fill_colorblind()+
  theme_minimal()
```
